###############################################################################
# UAT ENVIRONMENT - main.tf
# Calls all shared infrastructure modules for the User Acceptance Testing env.
#
...
module "vpc" {
  ...
  single_nat_gateway        = true  # Cost-saving single NAT in UAT
  enable_flow_logs          = false # Disable Flow Logs in UAT for cost
...
module "ecs_service_a" {
  ...
  environment_variables = [
    { name = "SPRING_PROFILES_ACTIVE", value = "uat" },
